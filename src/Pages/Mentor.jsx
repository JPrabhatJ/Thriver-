...
const Exam = () => {
  ...
  <h1>Ashok Kashyap</h1>
  <p>
    Ashok Sir has mentored over 1 lakh students and has cracked the CAT exam seven times, each with a 99+ percentile. His deep expertise and experience will undoubtedly help students confidently tackle Phase 1 of any competitive exam.
  </p>
</div>
      ...
      <div className="box">
       ...
       <h1>Abhishek Shah</h1>
        <p>Abhishek Shah has successfully cracked SEBI and RBI exams and secured an All India Rank 3 in the NABARD exam. He possesses deep insight into the strategies, tips, and tricks required to crack competitive exams efficiently—with the right guidance and approach.</p>
      </div>

      <div className="box">
        <img src="/AvniMentor.jpeg" alt="Avni Rathore" className="exam-image" />
       <h1>Tanya Rathore</h1>
        <p>Tanya, an IIM Kozhikode alumna, left her role at McKinsey to pursue her passion for teaching and mentoring students in cracking the aptitude sections of major competitive exams. She scored an impressive 99.93 percentile in the CAT and, prior to her MBA, worked for three years as a Management Trainee at Punjab National Bank.</p>
      </div>
    </div>
  );
};
